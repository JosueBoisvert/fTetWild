...
void Mesh::one_ring_vertex_coloring(std::vector<double>& colors) const
{
...
void Mesh::one_ring_vertex_sets(const int                      threshold,
...
void Mesh::one_ring_edge_set(const std::vector<std::array<int, 2>>&      edges,
